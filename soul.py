...
def handle_soul(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            response = "✅A͢v͢a͢i͢l͢a͢b͢l͢e͢ r͢i͢g͢h͢t͢ n͢o͢w͢✅ :- /fuck <ip> <port> <time>"  
    else:
...
💥 /fuck : Method For insane Servers. 
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 W͙e͙l͙c͙o͙m͙e͙ t͙o͙ CUMBACK BOT ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
